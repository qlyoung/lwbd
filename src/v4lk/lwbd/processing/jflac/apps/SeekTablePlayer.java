package v4lk.lwbd.processing.jflac.apps;
...
import v4lk.lwbd.processing.jflac.FrameListener;
import v4lk.lwbd.processing.jflac.PCMProcessor;
import v4lk.lwbd.processing.jflac.frame.Frame;
import v4lk.lwbd.processing.jflac.io.RandomFileInputStream;
import v4lk.lwbd.processing.jflac.metadata.Metadata;
import v4lk.lwbd.processing.jflac.metadata.SeekPoint;
import v4lk.lwbd.processing.jflac.metadata.SeekTable;
...
public class SeekTablePlayer implements PCMProcessor, FrameListener {
     ...
     * @see v4lk.lwbd.processing.jflac.PCMProcessor#processStreamInfo(v4lk.lwbd.processing.jflac.metadata.StreamInfo)
     */
     ...
     * @see v4lk.lwbd.processing.jflac.PCMProcessor#processPCM(org.kc7bfi.jflac.util.ByteSpace)
     */
     ...
     * @see v4lk.lwbd.processing.jflac.FrameListener#processError(String)
     */
